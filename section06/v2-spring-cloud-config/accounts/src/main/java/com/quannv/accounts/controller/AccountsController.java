package com.quannv.accounts.controller;

import com.quannv.accounts.constants.AccountsConstants;
import com.quannv.accounts.dto.AccountsContactInfoDto;
import com.quannv.accounts.dto.CustomerDto;
import com.quannv.accounts.dto.ErrorResponseDto;
import com.quannv.accounts.dto.ResponseDto;
...
@Tag(
    name = "CRUD REST APIs for Accounts in QuanNvBank",
    description = "CRUD REST APIs in QuanNvBank to CREATE, FETCH, UPDATE AND DELETE account details"
)
@RestController
...
public class AccountsController {
  ...
  @Operation(
      ...
      description = "REST API to create new Customer & Account inside QuanNvBank"
  )
  @ApiResponses({
      @ApiResponse(
          responseCode = "201",
